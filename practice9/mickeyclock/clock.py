...
class Clock:
    def __init__(self):
        ...
        self.second_hand = pygame.image.load("images/hour.png")
    ...
    def get_time_angles(self):
        now = datetime.now() #tekushee vremya

        minute = now.minute
        second = now.second + now.microsecond / 1_000_000 #smooth 

        minute_angle = (minute + second / 60) * 6 # 1 minut = 6 gr
        second_angle = second * 6 # 6 gr na second
